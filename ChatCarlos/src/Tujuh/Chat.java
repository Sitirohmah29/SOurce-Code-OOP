    ...
    private class ChatPanel extends JPanel {
        ...
        private void sendMessage(String contact) {
            ...
            if (!message.isEmpty()) {
                try {
                    ...
                    chatArea.append("You: " + message + " (Encrypted: " + encryptedMessage + ")\n");
        ...
        private void receiveMessage(String encryptedMessage) {
            try {
                ...
                chatArea.append("Contact: " + decryptedMessage + " (Encrypted: " + encryptedText + ")\n");
                messages.add("Contact: " + decryptedMessage);
            } catch (Exception ex) {
                ex.printStackTrace();
            }
        }
